...
const ProjectModal = ({ project, onClose }) => {
    ...
    () => [
      {
        name: "Quiz Game",
        description:
          "'<i>Quiz Game</i>' allows users to play a 10-question quiz across a wide variety of categories, either as a guest or by logging in with their Google account. <br> The game tracks scores for logged-in users, displaying their progress on a leaderboard and within a personal scores section.",
        technologies:
      ...
      },
      {
        name: "Find Users",
        description:
          "'<i>Find Users</i>' allows users to create profiles, browse a user list, retrieve details, and save favorites. It is designed as a boilerplate prototype for user directory and profile management functionality.",
        technologies:
          "<ul style='list-style: disc; padding-left: 20px; margin: 0;'>"
          + "<li style='margin-top:5px; margin-bottom:5px; font-size: 1.1rem;'>Vue 3 <img style='margin-left:7px;' src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vuejs/vuejs-original.svg' alt='Vue 3' width='20'></li>"
      ...
      },
      {
        name: "Omnifood",
        description:
          "'<i>Omnifood</i>' was developed as part of an HTML, JavaScript, and CSS course, demonstrating the basics of building a dynamic, user-friendly website. <br> It is a prototype for a meal subscription service designed to deliver personalized, healthy meals to customers' doors every day.",
        technologies:
          "<ul style='list-style: disc; padding-left: 20px; margin: 0;'>"
          + "<li style='margin-top:5px; margin-bottom:5px; font-size: 1.1rem;'>JavaScript <img style='margin-left:7px; margin-bottom:5px;' src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg' alt='JavaScript' width='20'></li>"
          + "<li style='margin-top:5px; margin-bottom:5px; font-size: 1.1rem;'>HTML <img style='margin-left:7px; margin-bottom:5px;' src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg' alt='HTML' width='20'></li>"
      ...
      },
      {
        name: "Bankist",
        description:
          "'<i>Bankist</i>' was developed as part of a JavaScript and CSS course, that showcases a minimalist digital banking experience. <br>The website focuses on providing a modern, user-friendly interface, and demonstrates the application of JavaScript and CSS in creating interactive and responsive web applications.",
        technologies:
          "<ul style='list-style: disc; padding-left: 20px; margin: 0;'>"
          + "<li style='margin-top:5px; margin-bottom:5px; font-size: 1.1rem;'>JavaScript <img style='margin-left:7px; margin-bottom:5px;' src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg' alt='JavaScript' width='20'></li>"
          + "<li style='margin-top:5px; margin-bottom:5px; font-size: 1.1rem;'>HTML <img style='margin-left:7px; margin-bottom:5px;' src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg' alt='HTML' width='20'></li>"
      ...
      },
      {
        name: "uHost",
        description:
          "'<i>uHost</i>' is a simple website created as part of a basic HTML and CSS course. <br>It showcases a hosting company offering three different plans: Free, Plus, and Premium, with varying features such as storage, support, and workspaces.",
        technologies:
          "<ul style='list-style: disc; padding-left: 20px; margin: 0;'>"
          + "<li style='margin-top:5px; margin-bottom:5px; font-size: 1.1rem;'>JavaScript <img style='margin-left:7px; margin-bottom:5px;' src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg' alt='JavaScript' width='20'></li>"
          + "<li style='margin-top:5px; margin-bottom:5px; font-size: 1.1rem;'>HTML <img style='margin-left:7px; margin-bottom:5px;' src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg' alt='HTML' width='20'></li>"
  ...
  useEffect(() => {
    const handleMouseDown = (e) => {
      const content = document.querySelector(".project-modal");
      if (content && !content.contains(e.target)) onClose();
    };
  ...
  const modal = (
    <div className="project-modal-overlay" role="dialog" aria-hidden="true">
      <div
        className="modal-dialog modal-dialog-centered modal-dialog-scrollable text-light"
        role="document"
      >
  ...
  // Render in a portal so it always sits above the navbar/offcanvas stacking contexts
  const portalRoot =
...
ProjectModal.propTypes = {
  project: PropTypes.string.isRequired, // expects project NAME string
